        ...
        if (response.payload) {
            ...
            setUser({
                ...
                connection:{
                    ...
                    followsMe:user.connection.followsMe,
                    requested:user.connection.requested,
                    blockedMe:user.connection.blockedMe,
                    didIBlock:true
                }
            } as IAccount);
        }
  ...
  return (
    user && (
      <div className="container mt-5 mb-5">
        {user.connection.blockedMe ? (
          ...
          <div className="row no-gutters">
            <div className="col-md-4 col-lg-4">
              <img src={user.picture ? BASE + user.picture : DEF} alt="Profile" />
            </div>
        ...
        <Gallery posts={!user.posts ? [] : user.posts} onUpdate={handlePostUpdate} />
      </div>
    )
  );
};
